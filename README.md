...
| -------- | ----------------- | ------|
| [purescript/purescript](https://github.com/purescript/purescript) | A small strongly typed language that compiles to Javascript | 1990 |
| [slamdata/purescript-halogen](https://github.com/slamdata/purescript-halogen) | A declarative, type-safe UI library for PureScript. | 248 |
| [bodil/pulp](https://github.com/bodil/pulp) | A build system and package manager for PureScript projects | 171 |
| [purescript-contrib/purescript-react](https://github.com/purescript-contrib/purescript-react) | React Bindings for PureScript | 143 |
| [bodil/purescript-signal](https://github.com/bodil/purescript-signal) | Elm style FRP library for PureScript | 114 |
| [paf31/purescript-book](https://github.com/paf31/purescript-book) | Sources for the PureScript book | 101 |
...
| [zrho/purescript-optic-ui](https://github.com/zrho/purescript-optic-ui) | PureScript UI framework based on lenses. | 54 |
| [sharkdp/purescript-flare](https://github.com/sharkdp/purescript-flare) | A special-purpose UI library for Purescript | 52 |
| [kRITZCREEK/psc-ide](https://github.com/kRITZCREEK/psc-ide) | Editor Support for the PureScript programming language | 48 |
| [slamdata/purescript-aff](https://github.com/slamdata/purescript-aff) | An asynchronous effect monad for PureScript | 44 |
...
| [aktowns/purescript-simple-dom](https://github.com/aktowns/purescript-simple-dom) |  | 33 |
| [waterson/purescript-asteroids](https://github.com/waterson/purescript-asteroids) | Asteroids for a web browser, in PureScript | 32 |
...
| [pelotom/purescript-d3](https://github.com/pelotom/purescript-d3) | PureScript bindings for D3 | 31 |
...
| [purescript/pursuit](https://github.com/purescript/pursuit) | Search engine for PureScript functions | 26 |
| [kRITZCREEK/FROST-Frontend](https://github.com/kRITZCREEK/FROST-Frontend) | Reactive Programming with PureScript and React | 25 |
| [garyb/purescript-virtual-dom](https://github.com/garyb/purescript-virtual-dom) | Low level virtual-dom bindings for PureScript | 24 |
...
| [purescript-contrib/purescript-parsing](https://github.com/purescript-contrib/purescript-parsing) | A parser combinator library based on Parsec | 23 |
...
| [AlexeyRaga/purescript-react-electron-example](https://github.com/AlexeyRaga/purescript-react-electron-example) |  | 18 |
...
| [purescript/purescript-transformers](https://github.com/purescript/purescript-transformers) | Monad and comonad transformers | 17 |
| [anttih/purescript-rx](https://github.com/anttih/purescript-rx) | PureScript bindings for RxJS | 17 |
| [slamdata/purescript-css](https://github.com/slamdata/purescript-css) | A clean, type-safe library for describing, manipulating and rendering CSS | 16 |
| [andreypopp/purescript-node-thunk](https://github.com/andreypopp/purescript-node-thunk) | Node callbacks as thunks | 16 |
| [anchor/servant-purescript](https://github.com/anchor/servant-purescript) | Purescript client code generation for Servant | 16 |
| [pelotom/purescript-easy-ffi](https://github.com/pelotom/purescript-easy-ffi) | Easy FFI for PureScript | 16 |
| [purescript/purescript-free](https://github.com/purescript/purescript-free) | Free monads, Cofree comonads, Yoneda and Coyoneda functors, and the Trampoline monad. | 16 |
| [jutaro/purescript-webgl](https://github.com/jutaro/purescript-webgl) | Binding to WebGL for purescript. | 15 |
| [paf31/purescript-jquery](https://github.com/paf31/purescript-jquery) | Type declarations for jQuery | 14 |
| [purescript/purescript-foreign](https://github.com/purescript/purescript-foreign) | Library for dealing with foreign data (JSON and JavaScript objects) in PureScript | 14 |
| [ethul/purs-loader](https://github.com/ethul/purs-loader) | PureScript loader for webpack | 14 |
...
| [tfausak/purescript-batteries](https://github.com/tfausak/purescript-batteries) | :battery: A PureScript prelude with more features. | 13 |
...
| [paf31/purescript-canvas](https://github.com/paf31/purescript-canvas) | Canvas bindings for PureScript | 13 |
...
| [owickstrom/purescript-spec](https://github.com/owickstrom/purescript-spec) | Simple testing framework for Purescript | 12 |
| [parsonsmatt/purs-architecture-tutorial](https://github.com/parsonsmatt/purs-architecture-tutorial) | A port of the Elm Architecture Tutorial to PureScript | 12 |
...
| [purescript-contrib/purescript-strongcheck](https://github.com/purescript-contrib/purescript-strongcheck) |  | 12 |
...
| [slamdata/purescript-routing](https://github.com/slamdata/purescript-routing) | A clean, type-safe routing library for PureScript. | 9 |
| [slamdata/purescript-echarts](https://github.com/slamdata/purescript-echarts) | Purescript bindings for Baidu's Echarts library | 9 |
| [philopon/haskell-purescript-binding](https://github.com/philopon/haskell-purescript-binding) | [WIP] generate purescript code from haskell code. | 8 |
| [purescript-contrib/purescript-base](https://github.com/purescript-contrib/purescript-base) |  | 8 |
...
| [EugeneN/pureGoL](https://github.com/EugeneN/pureGoL) | A Game of Life written in Purescript using Rx and React/canvas/console UIs. | 8 |
...
| [joneshf/purescript-optic](https://github.com/joneshf/purescript-optic) | null | 7 |
| [zudov/purescript-cycle](https://github.com/zudov/purescript-cycle) | Purescript bindings for Cycle.js | 7 |
| [purescript-node/purescript-node-http](https://github.com/purescript-node/purescript-node-http) | A wrapper for Node's HTTP APIs | 7 |
| [CapillarySoftware/presentable](https://github.com/CapillarySoftware/presentable) | A minimal PureScript rendering agnostic UI framework | 7 |
| [purescript/purescript-lazy](https://github.com/purescript/purescript-lazy) | Call-by-need values | 7 |
| [joneshf/sublime-purescript](https://github.com/joneshf/sublime-purescript) | null | 7 |
| [purescript/trypurescript](https://github.com/purescript/trypurescript) | PureScript in the browser | 7 |
| [paf31/purescript-free-canvas](https://github.com/paf31/purescript-free-canvas) | A free monad interface to the canvas | 7 |
| [purescript/purescript-lists](https://github.com/purescript/purescript-lists) | Linked Lists | 7 |
...
| [tfausak/purescript-neon](https://github.com/tfausak/purescript-neon) | :zap: An experimental PureScript prelude. | 6 |
...
| [ethul/purescript-freeap](https://github.com/ethul/purescript-freeap) |  | 6 |
| [paf31/purescript-behaviors](https://github.com/paf31/purescript-behaviors) | A simple FRP implementation which separates events and behaviors | 6 |
...
| [joneshf/purescript-lens-examples](https://github.com/joneshf/purescript-lens-examples) | null | 6 |
| [paf31/psc-pages](https://github.com/paf31/psc-pages) | A HTML documentation generator for PureScript sources | 6 |
| [adinapoli/snaplet-purescript](https://github.com/adinapoli/snaplet-purescript) | Automatic (re)compilation of Purescript code | 6 |
| [osa1/psc-lua](https://github.com/osa1/psc-lua) | Lua backend for PureScript | 6 |
| [bitc/purescript-bundle-fast](https://github.com/bitc/purescript-bundle-fast) | A fast alternative to PureScript's `psc-bundle` to be used during development | 6 |
| [purescript/purescript-tuples](https://github.com/purescript/purescript-tuples) | Tuple data type and utility functions | 6 |
| [purescript/purescript-arrows](https://github.com/purescript/purescript-arrows) | Type classes for Arrows. | 6 |
| [algas/purescript-enchantjs](https://github.com/algas/purescript-enchantjs) | PureScript interface for Enchant.js | 5 |
| [purescript-contrib/purescript-profunctor-lenses](https://github.com/purescript-contrib/purescript-profunctor-lenses) | Pure profunctor lenses | 5 |
| [fujimura/purescript-react-example](https://github.com/fujimura/purescript-react-example) | PureScript + React.js example, based on https://github.com/purescript-contrib/purescript-react. | 5 |
| [joneshf/purescript-node-webkit](https://github.com/joneshf/purescript-node-webkit) | null | 5 |
| [purescript/purescript-foldable-traversable](https://github.com/purescript/purescript-foldable-traversable) | Classes for foldable and traversable data structures | 5 |
| [purescript/purescript-monoid](https://github.com/purescript/purescript-monoid) | Monoid algebraic structure | 5 |
| [purescript/purescript-math](https://github.com/purescript/purescript-math) | Math functions | 5 |
| [purescript-contrib/purescript-dom](https://github.com/purescript-contrib/purescript-dom) | Type definitions and standard effect for interacting with the DOM | 5 |
| [anthoq88/purescript-three](https://github.com/anthoq88/purescript-three) | Purescript bindings for Threejs | 5 |
...
| [purescript/purescript-sets](https://github.com/purescript/purescript-sets) | Purely functional set data structure  | 5 |
| [slamdata/purescript-jtable](https://github.com/slamdata/purescript-jtable) | A Purescript table renderer capable of displaying multidimensional, heterogeneous JSON data | 5 |
...
| [purescript/purescript-arrays](https://github.com/purescript/purescript-arrays) | Array utility functions | 4 |
| [taku0/purescript_fingertree](https://github.com/taku0/purescript_fingertree) | Naive implementation of 2-3 finger-tree in PureScript | 4 |
